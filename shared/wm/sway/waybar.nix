...
in {
  ...
  environment = {
    etc."xdg/waybar/style.css".source =
      pkgs.writeText "waybar-style" (builtins.catAttrs "style" modules) + style;

    etc."xdg/waybar/config".source =
      pkgs.writeText "waybar-config" (builtins.catAttrs "config" modules)
      + config;
